...
| `BorderFunctional`      | #8E8699 / #8A80A3 | Funktionale Ränder (nicht Eingabefelder)  |
...
- `AppTextField(placeholder:text:…)` — Eingabefeld nach Entwurf: getönte
  Fläche ohne Rand, Beschriftung im Feld statt als Label-Zeile, optionale
  Auge-Schaltfläche fürs Passwort.
