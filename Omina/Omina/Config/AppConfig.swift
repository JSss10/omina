...
enum AppConfig {
    ...
    static let district1Center = CLLocationCoordinate2D(latitude: 47.3710, longitude: 8.5400)
    ...
    static let oldTownCenter = CLLocationCoordinate2D(latitude: 47.3703, longitude: 8.5417)
    static let oldTownRadiusM: Double = 1_200
    ...
    // Der GraphQL-Endpoint selbst steht nur im Import-Script
    // (scripts/import_ginto.py) – die App liest POIs ausschliesslich über
    // Supabase, nicht direkt bei ginto.
